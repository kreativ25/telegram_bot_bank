...
term = 700
data_usd = curs_nb_all('usd', max_date_curs_nb(), term)

x = []
y = []

for i in range(len(data_usd)):
    x.append(data_usd[i][0])
    y.append(float(data_usd[i][1]))

cur_name = 'Доллара США'
